...
// modified to allow adding captions to videos
// may eventually roll it into gatsby-remark-images-cloudinary
...
<figure class="gatsby-resp-image-figure">
    <video
      ...
      ${options.loop ? 'loop' : ''}
    ></video>
    <figcaption class="gatsby-resp-image-figcaption">${options.title}</figcaption>
</figure>
  `
